...
async function findAndFetchAllTermsContent() {
  ...
  if (matchedLinks.length === 0) {
    ...
    chrome.runtime.sendMessage({ action: 'processingError', message: 'No Terms of Use or Privacy Policy found on this page.' });
    return;
  }
  ...
  if (allTermsContent) {
    ...
    chrome.runtime.sendMessage({ action: 'processingError', message: 'Failed to extract Terms of Use content.' });
  }
}
